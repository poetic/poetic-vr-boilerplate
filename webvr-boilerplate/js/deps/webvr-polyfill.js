(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
  ...
  Meteor.THREE = require('./three-math.js');
  ...
  function GyroPositionSensorVRDevice() {
    ...
    this.lastOrientation = new Meteor.THREE.Quaternion();

    // Helper objects for calculating orientation.
    this.finalQuaternion = new Meteor.THREE.Quaternion();
    this.tmpQuaternion = new Meteor.THREE.Quaternion();
    this.deviceEuler = new Meteor.THREE.Euler();
    this.screenTransform = new Meteor.THREE.Quaternion();
    // -PI/2 around the x-axis.
    this.worldTransform = new Meteor.THREE.Quaternion(-Math.sqrt(0.5), 0, 0, Math.sqrt(0.5));
  }
  ...
  GyroPositionSensorVRDevice.prototype.getOrientation = function() {
    ...
    var alpha = Meteor.THREE.Math.degToRad(this.deviceOrientation.alpha);
    // Front-to-back (in portrait) rotation (x-axis).
    var beta = Meteor.THREE.Math.degToRad(this.deviceOrientation.beta);
    // Left to right (in portrait) rotation (y-axis).
    var gamma = Meteor.THREE.Math.degToRad(this.deviceOrientation.gamma);
    var orient = Meteor.THREE.Math.degToRad(this.screenOrientation);
  ...
  function MouseKeyboardPositionSensorVRDevice() {
    ...
    this.euler = new Meteor.THREE.Euler();
    this.orientation = new Meteor.THREE.Quaternion();

    // Variables for mouse-based rotation.
    this.rotateStart = new Meteor.THREE.Vector2();
    this.rotateEnd = new Meteor.THREE.Vector2();
    this.rotateDelta = new Meteor.THREE.Vector2();
  }
  ...
  /*
   * A subset of Meteor.THREE.js, providing mostly quaternion and euler-related
  ...
  // Only use if the real Meteor.THREE is not provided.

  Meteor.THREE = Meteor.THREE || {};

  // If some piece of Meteor.THREE is missing, fill it in here.
  if (!Meteor.THREE.Quaternion || !Meteor.THREE.Vector3 || !Meteor.THREE.Vector2 || !Meteor.THREE.Euler) {
    console.log('No Meteor.THREE.js found.');
    ...
    Meteor.THREE.Quaternion.prototype = {
      ...
      multiply: function ( q, p ) {
        ...
        if ( p !== undefined ) {
          ...
          console.warn( 'Meteor.THREE.Quaternion: .multiply() now only accepts one argument. Use .multiplyQuaternions( a, b ) instead.' );
      ...
      multiplyVector3: function ( vector ) {
        ...
        console.warn( 'Meteor.THREE.Quaternion: .multiplyVector3() has been removed. Use is now vector.applyQuaternion( quaternion ) instead.' );
    ...
    Meteor.THREE.Vector2.prototype = {
      ...
      add: function ( v, w ) {
        ...
        if ( w !== undefined ) {
          ...
          console.warn( 'Meteor.THREE.Vector2: .add() now only accepts one argument. Use .addVectors( a, b ) instead.' );
      ...
      sub: function ( v, w ) {
        ...
        if ( w !== undefined ) {
          ...
          console.warn( 'Meteor.THREE.Vector2: .sub() now only accepts one argument. Use .subVectors( a, b ) instead.' );
    ...
    Meteor.THREE.Vector3.prototype = {
      ...
      add: function ( v, w ) {
        ...
        if ( w !== undefined ) {
          ...
          console.warn( 'Meteor.THREE.Vector3: .add() now only accepts one argument. Use .addVectors( a, b ) instead.' );
          return this.addVectors( v, w );
      ...
      sub: function ( v, w ) {
        ...
        if ( w !== undefined ) {
          ...
          console.warn( 'Meteor.THREE.Vector3: .sub() now only accepts one argument. Use .subVectors( a, b ) instead.' );
          return this.subVectors( v, w );
      ...
      multiply: function ( v, w ) {
        ...
        if ( w !== undefined ) {
          ...
          console.warn( 'Meteor.THREE.Vector3: .multiply() now only accepts one argument. Use .multiplyVectors( a, b ) instead.' );
      ...
      applyEuler: function () {
        ...
        return function ( euler ) {
          ...
          if ( euler instanceof Meteor.THREE.Euler === false ) {
            ...
            console.error( 'Meteor.THREE.Vector3: .applyEuler() now expects a Euler rotation rather than a Vector3 and order.' );
      ...
      cross: function ( v, w ) {
        ...
        if ( w !== undefined ) {
          ...
          console.warn( 'Meteor.THREE.Vector3: .cross() now only accepts one argument. Use .crossVectors( a, b ) instead.' );
      ...
      setEulerFromRotationMatrix: function ( m, order ) {
        ...
        console.error( 'Meteor.THREE.Vector3: .setEulerFromRotationMatrix() has been removed. Use Euler.setFromRotationMatrix() instead.' );

      },

      setEulerFromQuaternion: function ( q, order ) {

        console.error( 'Meteor.THREE.Vector3: .setEulerFromQuaternion() has been removed. Use Euler.setFromQuaternion() instead.' );

      },

      getPositionFromMatrix: function ( m ) {

        console.warn( 'Meteor.THREE.Vector3: .getPositionFromMatrix() has been renamed to .setFromMatrixPosition().' );
      ...
      getScaleFromMatrix: function ( m ) {
        ...
        console.warn( 'Meteor.THREE.Vector3: .getScaleFromMatrix() has been renamed to .setFromMatrixScale().' );
      ...
      getColumnFromMatrix: function ( index, matrix ) {
        ...
        console.warn( 'Meteor.THREE.Vector3: .getColumnFromMatrix() has been renamed to .setFromMatrixColumn().' );
    ...
    Meteor.THREE.Euler.prototype = {
      ...
      setFromRotationMatrix: function ( m, order, update ) {
        ...
        if ( order === 'XYZ' ) {
          ...
          console.warn( 'Meteor.THREE.Euler: .setFromRotationMatrix() given unsupported order: ' + order )
